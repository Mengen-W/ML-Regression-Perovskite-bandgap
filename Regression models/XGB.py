...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 21 17:40:21 2025
...
for i, (train_idx, test_idx) in enumerate(LeaveOneOut().split(X_fl)):
    ...
    # Predict
    Pred_fl[test_idx] = best_xgb.predict(X_test)
...
plt.tight_layout()
plt.savefig('XGB_FeatureImportance.png', dpi=450)
plt.show()
...
plt.tight_layout()
plt.savefig('XGB_LOOCV.png', dpi=450)
plt.show()