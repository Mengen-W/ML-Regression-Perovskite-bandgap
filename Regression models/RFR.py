...
# -*- coding: utf-8 -*-
"""
Created on Mon Apr 21 10:21:50 2025
...
for i, (train_idx, test_idx) in enumerate(LeaveOneOut().split(X_fl)):
    ...
    rfreg = RandomForestRegressor(random_state=7, n_jobs=1)
    ...
    # Predict
    Pred_fl[test_idx] = best_rfreg.predict(X_test)
    
    # Save best params
    best_params_list.append(grid_search.best_params_)
    
    # Save feature importances
    feature_importances_list.append(best_rfreg.feature_importances_)
...
plt.tight_layout()
plt.savefig('RFR_FeatureImportance.png', dpi=450)
plt.show()
...
plt.tight_layout()
plt.savefig('RFR_LOOCV.png', dpi=450)
plt.show()